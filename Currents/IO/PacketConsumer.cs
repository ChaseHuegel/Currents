            ...
            using (recvEvent)
            {
                ...
                if ((header.Controls & (byte)Packets.Controls.Ack) != 0)
                {
                    ...
                    if (!isPiggybackAck)
                    {
                        ...
                        {
                            var dataEvent = new PacketEvent<byte[]>(ack.Data, recvEvent.EndPoint, recvEvent.Data.Count, header);
                    ...
                    ack.Data = null;
                    var packetEvent = new PacketEvent<Ack>(ack, recvEvent.EndPoint, recvEvent.Data.Count, header);
                ...
                if ((header.Controls & (byte)Packets.Controls.Syn) != 0)
                {
                    ...
                    var packetEvent = new PacketEvent<Syn>(syn, recvEvent.EndPoint, recvEvent.Data.Count, header);
